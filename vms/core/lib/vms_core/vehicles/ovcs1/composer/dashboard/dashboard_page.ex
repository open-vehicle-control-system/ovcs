      ...
      blocks: %{
        ...
        "Modules Status" => %{
          ...
          metrics: [
            ...
            %{name: "Front Controller alive", module: OVCS1.FrontController, key: :is_alive},
            %{name: "Controls Controller alive", module: OVCS1.ControlsController, key: :is_alive},
            %{name: "Rear Controller alive", module: OVCS1.RearController, key: :is_alive},
