defmodule VmsCore.Components.Evpt.Evpt23Charger do
  ...
  def handle_info({:handle_frame, %Frame{name: "charger_status", signals: signals}}, state) do
    %{
      ...
      "battery_disconnected_or_reverse_connection_protection_enabled" => %Signal{
        value: battery_disconnected_or_reverse_connection_protection_enabled
      },
      "ac_voltage_over_protection_enabled" => %Signal{value: ac_voltage_over_protection_enabled},
      "charger_over_temperature_protection_enabled" => %Signal{
        value: charger_over_temperature_protection_enabled
      },
    ...
    {:noreply,
     %{
       ...
       | output_voltage: output_voltage,
         ...
         battery_disconnected_or_reverse_connection_protection_enabled:
           battery_disconnected_or_reverse_connection_protection_enabled,
  ...
  defp emit_metrics(state) do
    Bus.broadcast("messages", %Bus.Message{
      name: :output_voltage,
      value: state.output_voltage,
      source: __MODULE__
    })

    Bus.broadcast("messages", %Bus.Message{
      name: :output_current,
      value: state.output_current,
      source: __MODULE__
    })

    Bus.broadcast("messages", %Bus.Message{
      name: :communication_timeout_failure,
      value: state.communication_timeout_failure,
      source: __MODULE__
    })

    Bus.broadcast("messages", %Bus.Message{
      name: :battery_disconnected_or_reverse_connection_protection_enabled,
      value: state.battery_disconnected_or_reverse_connection_protection_enabled,
      source: __MODULE__
    })

    Bus.broadcast("messages", %Bus.Message{
      name: :ac_voltage_over_protection_enabled,
      value: state.ac_voltage_over_protection_enabled,
      source: __MODULE__
    })

    Bus.broadcast("messages", %Bus.Message{
      name: :charger_over_temperature_protection_enabled,
      value: state.charger_over_temperature_protection_enabled,
      source: __MODULE__
    })

    Bus.broadcast("messages", %Bus.Message{
      name: :hardware_failure,
      value: state.hardware_failure,
      source: __MODULE__
    })
