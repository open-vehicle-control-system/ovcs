...
config :nerves, :erlinit, hostname_pattern: Application.get_env(:radio_control_bridge_firmware, :vehicle_host)
...
config :mdns_lite,
  ...
  hosts: [:hostname, Application.get_env(:radio_control_bridge_firmware, :vehicle_host)],
  ttl: 120,
