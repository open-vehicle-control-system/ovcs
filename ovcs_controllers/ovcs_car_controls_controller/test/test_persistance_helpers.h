...
namespace PersistanceHelpersTest{
    ...
    void test_read_calibration_data_doesnt_alter_stored_data(){
        ...
        TEST_ASSERT_EQUAL_INT(255, read_calibration_data((char*)"throttle_high"));
    }
