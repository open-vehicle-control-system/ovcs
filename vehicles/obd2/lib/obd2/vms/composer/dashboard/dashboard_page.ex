      ...
      blocks: %{
        "vehicle-information" => %{
          ...
          rows: [
            ...
            %{
              type: :metric,
              name: "Stored DTC count",
              module: Diagnostics,
              key: :stored_dtc_count
            },
            %{
              type: :metric,
              name: "Pending DTC count",
              module: Diagnostics,
              key: :pending_dtc_count
            },
            %{
              type: :metric,
              name: "Permanent DTC count",
              module: Diagnostics,
            ...
            %{
              type: :metric,
              name: "Supported PID count",
              module: Diagnostics,
              key: :supported_pid_count
            }
          ]
        },
        "rpm-speed" => %{
