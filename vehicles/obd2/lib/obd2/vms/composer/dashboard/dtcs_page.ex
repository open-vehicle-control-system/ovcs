defmodule Obd2.Vms.Composer.Dashboard.DtcsPage do
      ...
      blocks: %{
        "obd2-dtcs" => %{
          ...
          rows: [
            %{
              type: :action,
              name: "Clear emission DTCs",
              input_type: :button,
              input_name: "Send Mode 04",
              module: Diagnostics,
              action: "clear_dtcs"
            },
            ...
            %{
              type: :metric,
              name: "Permanent count",
              module: Diagnostics,
              key: :permanent_dtc_count
            }
          ]
        },
        "uds-dtcs" => %{
          ...
          rows: [
            %{
              ...
              name: "Clear UDS DTCs",
              input_type: :button,
              input_name: "Send Mode 14",
              module: Diagnostics,
              action: "uds_clear_dtcs"
            },
