defmodule Ovcs1.Vms do
  ...
  alias Ovcs1.Vms.{FrontController, ControlsController, RearController}
  ...
  def handle_info(
        %Bus.Message{name: :ready_to_drive, value: ready_to_drive, source: HighVoltageContactors},
        state
      ) do
  ...
  def handle_info(
        %Bus.Message{name: :ready_to_drive, value: ready_to_drive, source: Inverter},
        state
      ) do
  ...
  def handle_info(
        %Bus.Message{name: :ready_to_drive, value: ready_to_drive, source: IBoosterGen2},
        state
      ) do
  ...
  def handle_info(
        %Bus.Message{name: :is_alive, value: is_alive, source: ControlsController},
        state
      ) do
