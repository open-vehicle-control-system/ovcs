defmodule Ovcs1.Vms.Composer.Dashboard.Blocks.ThrottleChart do
  ...
  def definition(order: order, full_width: full_width) do
    %{
      ...
      y_axis: [
        %{
          min: 0,
          max: ThrottlePedal.raw_max_throttle(),
          label: "Raw",
          series: [
        ...
        %{
          ...
          series: [
            %{
              name: "Computed Throttle",
              metric: %{module: ThrottlePedal, key: :requested_throttle}
            }
          ]
        }
      ]
