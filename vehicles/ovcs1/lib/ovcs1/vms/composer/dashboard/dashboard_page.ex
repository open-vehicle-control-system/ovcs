defmodule Ovcs1.Vms.Composer.Dashboard.DashboardPage do
  ...
  alias Ovcs1.Vms.Composer.Dashboard.Blocks
  alias Ovcs1.Vms
      ...
      blocks: %{
        ...
        "status" => %{
          ...
          rows: [
            ...
            %{type: :metric, name: "OVCS1 ready", module: Vms, key: :ready_to_drive},
            %{type: :metric, name: "Front Controller alive", module: Vms.FrontController, key: :is_alive},
            %{type: :metric, name: "Controls Controller alive", module: Vms.ControlsController, key: :is_alive},
            %{type: :metric, name: "Rear Controller alive", module: Vms.RearController, key: :is_alive},
            ...
            %{type: :metric, name: "Main Negative contactor enabled", module: Vms.RearController, key: :received_digital_pin3_enabled},
            %{type: :metric, name: "Main Positive contactor enabled", module: Vms.RearController, key: :received_digital_pin4_enabled},
            %{type: :metric, name: "Precharge contactor enabled", module: Vms.RearController, key: :received_digital_pin5_enabled}
          ]
        },
        "rpm-voltage" => %{
          order: 5,
