      ...
      blocks: %{
        ...
        "status" => %{
          ...
          rows: [
            ...
            %{
              type: :metric,
              name: "Front Controller alive",
              module: Vms.FrontController,
              key: :is_alive
            },
            %{
              type: :metric,
              name: "Controls Controller alive",
              module: Vms.ControlsController,
              key: :is_alive
            },
            %{
              type: :metric,
              name: "Rear Controller alive",
            ...
            %{
              type: :metric,
              name: "I Booster ready",
              module: Bosch.IBoosterGen2,
              key: :ready_to_drive
            },
            %{
              type: :metric,
              name: "Contactors ready",
              module: OVCS.HighVoltageContactors,
              key: :ready_to_drive
            },
            %{
              type: :metric,
              name: "Main Negative contactor enabled",
              module: Vms.RearController,
              key: :received_digital_pin3_enabled
            },
            %{
              type: :metric,
              name: "Main Positive contactor enabled",
              module: Vms.RearController,
              key: :received_digital_pin4_enabled
            },
            %{
              type: :metric,
              name: "Precharge contactor enabled",
              module: Vms.RearController,
          ...
          y_axis: [
            ...
            %{
              ...
              series: [
                %{
                  name: "Voltage",
                  metric: %{module: LeafAZE0.Inverter, key: :inverter_output_voltage}
                }
              ]
            }
          ]
