...
#
# Usage:
#   compose/local/scripts/calibrate.sh                           # 8x6 inner corners, 30 mm squares
#   compose/local/scripts/calibrate.sh 9x6                       # override corner count
#   compose/local/scripts/calibrate.sh 8x5 0.025                 # override corners + square size
#
