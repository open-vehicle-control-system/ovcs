...
- [ROS Compute Node](./ros_compute_node.md) — the OVCS Mini's non-Nerves Pi: why it exists, the immutable OS choice (balenaOS), the compute/local compose split, and how it wires into the Zenoh fabric.
